        ...
        <div className="flex-1 overflow-y-auto">
          {loading ? (
            <div className="p-4 space-y-3">
              {[1, 2, 3].map((i) => (
                <div key={i} className="animate-pulse h-14 rounded-[10px] bg-[#F5F5F0]" />
              ))}
            </div>
            ...
            conversations.map((conv) => (
              <button
                ...
                className={`w-full text-left p-4 border-b border-[#E2E0D9] last:border-b-0 hover:bg-[#EEF2FD] transition-colors ${
        ...
        <div className="flex-1 flex flex-col min-w-0">
          <div className="p-4 border-b border-[#E2E0D9] bg-white">
            ...
            {selected.otherPartyName && (
              <p className="text-[12px] text-[#5A5750]">{selected.otherPartyName}</p>
            )}
          </div>
          <div className="flex-1 overflow-y-auto p-4 space-y-3">
            {messages.map((m) => (
              ...
              >
                <div
                  className={`max-w-[70%] rounded-[16px] px-4 py-2.5 text-[14px] ${
                    m.senderId === "me"
